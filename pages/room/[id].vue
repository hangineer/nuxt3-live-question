...
const isProvide =  (isProvide = false) => {
  return isProvide ? "提供" : "不提供";
}
</script>
          ...
          <div class="room-page">
            ...
            <div class="room-gallery">
              ...
              <div class="room-image-list">
                <img
                  v-for="image in roomInfo.imageUrlList"
                  :key="image"
                  :src="image"
                  alt="圖片"
                />
            ...
            <div class="room-info">
              ...
              <div class="info-block">
                <h2>房間配置</h2>
                <ul>
                  <li v-for="layout in roomInfo.layoutInfo" :key="layout.title">{{ `${layout.title}: ${isProvide(layout.isProvide)}` }}</li>
                </ul>
              </div>
              ...
              <div class="info-block">
                <h2>房內設施</h2>
                <ul>
                  <li v-for="facility in roomInfo.facilityInfo" :key="facility.title">{{ `${facility.title}: ${isProvide(facility.isProvide)}` }}</li>
                </ul>
              </div>
              ...
              <div class="info-block">
                <h2>客房備品</h2>
                <ul>
                  <li v-for="amenity in roomInfo.amenityInfo" :key="amenity.title">{{ `${amenity.title}: ${isProvide(amenity.isProvide)}` }}</li>
                </ul>
              </div>
            </div>
          </div>
